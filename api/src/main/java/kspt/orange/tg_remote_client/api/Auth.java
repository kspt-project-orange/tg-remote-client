...
public final class Auth implements Api {
    ...
    public Response requestCode(@RequestBody @NotNull final RequestCodeRequest body) {
        if (body.isValid()) {
            return RequestCodeResponse.ok("jklj3kl4hj12l5hlhjh14kj5h21kl3j4l12h351j24h1kl45b1kjh32lk5h12;465l2k53");
        }

        return RequestCodeResponse.ERROR;
    }

    @PostMapping(path = "/signIn", consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
    @ResponseStatus(ACCEPTED)
    public Response signIn(@RequestBody @NotNull final SignInRequest body) {
        if (body.isValid()) {
            return SignInResponse.ok("jkj13k2j4klhjlj1243lj5hkj1h3jkhl;hklj1lk3l51jlk");
        }
    ...
    @ResponseStatus(ACCEPTED)
    public Response pass2Fa(@RequestBody @NotNull final Pass2FaRequest body) {
        if (body.isValid()) {
            return Pass2FaResponse.ok("jhkljh1j4h5jkh1jk24h5kj21h4kj5h12jk4h5klj12hk5j");
        }

        return Pass2FaResponse.ERROR;
    }
